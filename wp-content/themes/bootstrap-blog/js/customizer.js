...
( function( $ ) {
	...
	wp.customize( 'bootstrap_blog_logo_size', function( value ) {
		value.bind( function( to ) {
			$( '.logo .site-title' ).css( 'font-size', to + "px" );
	...
	wp.customize( 'bootstrap_blog_slider_layouts', function( value ) {
		value.bind( function( to ) {
			var slider_class;
			var remove_class;
			if( to == 'one' ) {
	...
	wp.customize( 'bootstrap_blog_featured_layouts', function( value ) {
		value.bind( function( to ) {
			var featured_class;
			var remove_class;
			if( to == 'one' ) {
