...
function bootstrap_blog_customize_register_featured_lifestyle( $wp_customize ) {
    ...
    $wp_customize->add_control( new Bootstrap_Blog_Radio_Image_Control( $wp_customize, 'bootstrap_blog_featured_layouts', array(
        ...
        'choices'     => array(
            ...
            'two'   => get_template_directory_uri() . '/images/homepage/featured-layouts/featured-layout-two.jpg',
            'three'   => get_template_directory_uri() . '/images/homepage/featured-layouts/featured-layout-three.jpg',
            'four'   => get_template_directory_uri() . '/images/homepage/featured-layouts/featured-layout-four.jpg',
        ),
    ) ) );
